...
class CNode(ASTNodeAbstractClass):
    LineNo = int
    ColumnNo = int
    ...
    def children(self) -> typing.List[Self]:
        '''child nodes'''
        return list(map(CNode, self.node.children))
